...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: false,
		src: "https://q2.qlogo.cn/headimg_dl?dst_uin=242531778&spec=0", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
